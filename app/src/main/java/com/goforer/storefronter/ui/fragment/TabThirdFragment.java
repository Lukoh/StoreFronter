...
public class TabThirdFragment extends TabBaseFragment {
    @Override
    ...
    protected void requestTabInfo(boolean isNew, TabInfoDataEvent event)
        ...
        Intermediary.INSTANCE.getCategoryItems(mContext.getApplicationContext(),
                Intermediary.CATEGORY_FIRST_TYPE, Intermediary.UID, event);
    }
}
