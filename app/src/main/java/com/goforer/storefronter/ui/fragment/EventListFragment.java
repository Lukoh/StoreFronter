...
import com.goforer.storefronter.ui.adapter.EventListAdapter;
...
public class EventListFragment extends RecyclerFragment<Event>  {
    ...
    protected void requestEventList(boolean isNew)
        ...
        Intermediary.INSTANCE.getEventList(mContext.getApplicationContext(), Intermediary.UID, event);
    }

    @SuppressWarnings("")
    @Subscribe(threadMode = ThreadMode.BACKGROUND)
    public void onEvent(EventListEvent event) {
