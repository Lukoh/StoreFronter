...
public abstract class RecyclerFragment<T> extends BaseFragment {
    ...
    private static class handleTask extends AsyncTask<Void, Void, List> {
        ...
        protected List doInBackground(Void... params) {
            ...
            switch (mEvent.getId()) {
                case ResponseEvent.EVENT_ID_CATEGORY:
                    //TODO:: Handle each event
                    jsonElement = ((ResponseCategoryData)mEvent.getResponseClient()).getCategoryItems();
                    break;
                case ResponseEvent.EVENT_ID_OFFER:
                    //TODO:: Handle each event
                    break;
                case ResponseEvent.EVENT_ID_COMMENT:
                    //TODO:: Handle each event
                    break;
                case ResponseEvent.EVENT_ID_PROFILE:
                    //TODO:: Handle each event
                    break;
                case ResponseEvent.EVENT_ID_GALLERY:
                    //TODO:: Handle each event
                    break;
                case ResponseEvent.EVENT_ID_EVENT:
                    //TODO:: Handle each event
                    mFragment.setTotalPage(((ResponseEventData)mEvent.getResponseClient()).getPages());
                    jsonElement = ((ResponseEventData)mEvent.getResponseClient()).getEvents();
                    break;
                default:
                    jsonElement = ((ResponseCategoryData)mEvent.getResponseClient()).getCategoryItems();
                    break;
            ...
            return mFragment.parseItems(jsonElement);
        }
